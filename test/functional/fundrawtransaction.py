...
from test_framework.tscconfig import COINBASE_MATURITY, INITIAL_BLOCK_REWARD
...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "changeAddress must be a valid tsc address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
