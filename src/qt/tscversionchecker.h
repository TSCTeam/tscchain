#ifndef TSCVERSIONCHECKER_H
#define TSCVERSIONCHECKER_H

#include <QObject>

#define TSC_RELEASES "https://github.com/tscproject/tsc/releases"
...
class TscVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit TscVersionChecker(QObject *parent = 0);
    ~TscVersionChecker();
