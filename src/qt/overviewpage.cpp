...
//#009ee5;QColor("#393939") : QColor("#2e2e2e");009ee5
        QRect mainRect = option.rect;
        QColor txColor = index.row() % 2 ? QColor("#ffffff") : QColor("#f5f5f5");
        painter->fillRect(mainRect, txColor);

        QPen pen;
        pen.setWidth(2);
        pen.setColor(QColor("#7aaffe"));
        painter->setPen(pen);
        ...
        if(amount < 0)
        {
            foreground = QColor("#666666");//COLOR_NEGATIVE;
        }
        else if(!confirmed)
        {
            foreground = QColor("#666666");//COLOR_UNCONFIRMED;
        }
        else
        {
            foreground = QColor("#666666");
        }
        painter->setPen(foreground);
...
public:
               ...
               const QModelIndex &index) const
    {
        ...
        painter->fillRect(hLineRect, QColor("#dddddd"));
//#dedede;#2e2e2e;#383938;
        QColor foreground("#666666");
        painter->setPen(foreground);
