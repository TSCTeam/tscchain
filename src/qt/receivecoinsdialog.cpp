    ...
    platformStyle(_platformStyle)
{
    ...
    if (!_platformStyle->getImagesOnButtons()) {
        ...
        ui->clearButton->setIcon(_platformStyle->MultiStatesIcon(":/icons/remove", PlatformStyle::PushButton,0x666666));
        ui->receiveButton->setIcon(_platformStyle->MultiStatesIcon(":/icons/request_payment", PlatformStyle::PushButton,0x666666));
        ui->showRequestButton->setIcon(_platformStyle->MultiStatesIcon(":/icons/show", PlatformStyle::PushButton,0x666666));
        ui->removeRequestButton->setIcon(_platformStyle->MultiStatesIcon(":/icons/remove", PlatformStyle::PushButton,0x666666));
    }
    ...
    this->setStyleSheet("#ReceiveCoinsDialog {background-color: #f5f5f5;}");
