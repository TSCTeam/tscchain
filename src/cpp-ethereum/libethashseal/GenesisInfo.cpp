...
#include "genesis/tscMainNetwork.cpp"
#include "genesis/tscTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::tscMainNetwork: return c_genesisInfoTscMainNetwork;
	case Network::tscTestNetwork: return c_genesisInfoTscTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::tscMainNetwork: return c_genesisStateRootTscMainNetwork;
	case Network::tscTestNetwork: return c_genesisStateRootTscTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
