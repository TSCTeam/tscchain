...
////////////////////////////////////////////////////////////// // tsc
	void setTscSchedule(EVMSchedule _tscSchedule) const { tscSchedule = _tscSchedule; }

	EVMSchedule& getTscSchedule() const { return tscSchedule; }
...
private:
	...
	mutable EVMSchedule tscSchedule; // tsc
